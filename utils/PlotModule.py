        ...
        if time.time() - self.ptime > self.interval:
            ...
            for i in range(0, len(self.yList)):
                if i < 2:
                    ...
                    point1 = (int((self.xList[i - 1] * (self.w // 100))) - (self.w // 10), self.yList[i - 1])
                    point2 = (int((self.xList[i] * (self.w // 100)) - (self.w // 10)), self.yList[i])
                    cv2.line(self.imgPlot, point1, point2, (255, 0, 255), 2)
